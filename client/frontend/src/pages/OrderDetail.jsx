...
import TrackingComponent from "../components/orders/TrackingComponent.jsx";
import {
    FaArrowLeft,
    FaBox,
    FaTruck,
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        {/* Shiprocket Tracking Component */}
                        <TrackingComponent order={order} />

                        {/* Order Status Timeline */}
                        {order.status === "shipped" && !order.shiprocket?.shipmentId && (
