                    ...
                    {step === "phone" && (
                        <>
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full bg-[#A89A3D] text-white font-semibold py-2 rounded hover:bg-yellow-700 transition disabled:bg-gray-400"
                            >
                    ...
                    {step === "otp" && (
                        <>
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full bg-green-600 text-white font-semibold py-2 rounded hover:bg-green-700 transition disabled:bg-gray-400 mb-2"
                            >
