            ...
            <div className="max-w-7xl mx-auto px-2 py-3 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4 relative">
                    ...
                    <div className="relative" ref={profileRef}>
                        ...
                        {profileOpen && (
                            <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border p-4 z-50 text-sm">
                                <h3 className="font-bold text-black mb-2">WELCOME</h3>
                                <p className="text-gray-700 mb-4">To access account and manage orders</p>
                                <Link
                                    to="/signup"
                                    className="block w-full text-center px-4 py-2 border border-black rounded-md hover:bg-black hover:text-white transition"
            ...
            >
                {categories.length > 0 ? (
                    categories.map((cat) => (
                        <Link
                            key={cat._id || cat.name}
                            to={`/products/${cat.slug || cat.name.toLowerCase()}`}
                ...
                <div className="fixed inset-0 z-50 bg-black/40 flex items-start justify-center md:hidden">
                    <div className="bg-secondary w-full px-4 py-4 flex items-center gap-2 shadow-lg relative">
                        ...
                        >
                            ...
                            <button type="submit" className="p-2 text-black hover:text-primary focus:outline-none">
                                <FaSearch className="text-lg" />
                            </button>
                            <button
                                type="button"
