    ...
    return (
        <div className="bg-white p-2 sm:p-6 rounded-xl border border-gray-200 shadow-sm">
            ...
            <div className="flex gap-2 mb-4">
                <button
                    type="button"
                    className={`flex-1 py-2 rounded-t-xl border-b-2 font-semibold transition-colors text-sm sm:text-base ${selected === "COD" ? "border-[#B76E79] text-[#B76E79] bg-[#F8E9ED]" : "border-gray-200 text-gray-500 bg-white hover:bg-gray-50"}`}
                ...
                <button
                    type="button"
                    className={`flex-1 py-2 rounded-t-xl border-b-2 font-semibold transition-colors text-sm sm:text-base ${selected === "ONLINE" ? "border-blue-400 text-blue-500 bg-blue-50" : "border-gray-200 text-gray-400 bg-white cursor-not-allowed opacity-60"}`}
                    disabled
                >
                    <span className="inline-flex items-center gap-1">
            ...
            {selected === "ONLINE" && (
                <div className="p-3 sm:p-4 bg-blue-50 border border-blue-200 rounded-xl">
                    ...
                    <div className="text-xs sm:text-sm text-blue-500">
                        <p>• Pay securely using Credit Card, Debit Card, UPI, Net Banking</p>
