          ...
          <div className="bg-white p-6 rounded-lg w-[90%] max-w-md relative">
            ...
            {["houseNumber", "street", "area", "city", "state", "pincode"].map((field) => (
              <input
                ...
                onChange={(e) => handleEditChange(field, field === "pincode" ? e.target.value.replace(/[^0-9]/g, "").slice(0, 6) : e.target.value)}
            ...
            <input
              ...
              onChange={(e) => handleEditChange("phone", e.target.value.replace(/[^0-9]/g, "").slice(0, 10))}
              className="border p-2 rounded w-full mb-3"
              maxLength={10}
            />
